...
import com.apple.android.music.playback.model.PlaybackState.PAUSED
import com.apple.android.music.playback.model.PlaybackState.PLAYING
import com.apple.android.music.playback.model.PlaybackState.STOPPED
...
actual class MediaPlayerNativePlayer : NativePlayer {
    ...
    actual override val currentPlaying: MusicEntry?
        get() =
            player?.currentItem?.item?.let { item ->
    ...
    private fun EntryData.buildCatalog() =
